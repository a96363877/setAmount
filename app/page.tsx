    ...
    <div className="max-w-md mx-auto bg-white min-h-screen flex flex-col">
      ...
      <main className="flex-1 overflow-auto">
        ...
        <div className="px-4 py-2">
          <h2 className="text-xl font-bold text-right text-teal-600 mb-3">
            فرحة ولدكم صقر
          </h2>
          <p className="text-right text-sm text-gray-700 mb-3 leading-relaxed">
            ...
            <br />
            صعوبة في الحركة إلى أن تم تشخيصه بالضمور في العضلات مما يستدعي
            العلاج المستمر حتى
            <br />
            إلى أن يصل إلى عضلة القلب (متوقف حالياً)
            <br />
            ساعدونا في إنقاذ صقر والمساهمة في علاجه إلى بقية عمره وتخفيف أسرته
            معه.
          </p>
        </div>
        ...
        <div className="px-4 py-2 mt-2">
          ...
          <div className="mb-4">
            <div className="border rounded-md p-3 flex items-center justify-between">
              ...
              <input className="text-right text-gray-400  px-4" />
              تليفون المتبرع
            </div>
          </div>
